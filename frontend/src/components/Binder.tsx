            ...
            <div className="Binder-cards">
                ...
                >
                    {card ? (
                        ...
                        <div className="empty-slot"draggable onDragStart={() => onDragStart(index)}>
                            Empty Slot
                        </div>
                    )}
                </div>
                ...
                <div className="card-slot empty-slot" key={`empty-${index}`}onDragOver={onDragOver} onDrop={() => onDrop(getPageData().length + index)}>
                    Empty Slot
                </div>
                ))}
            </div>
